...
- WP2
  ...
  - Emulate `vsetvl`/`vsetvli` without calls in the host code.
    - **In progress**: this was slowed down a bit in favour of the 
...
- WP3
  - Measure performance on AArch64
    ...
    - The memcpy benchmark shows a much worse performance regardless of the branch used
...
- WP3
  - Investigate the poor performance of QEMU on AArch64.
...
:![vle8.v VLEN=128 LMUL=1](./images/20240731-Aarch64-vle8.v-speedup-VLEN-128-LMUL-1.svg.svg)
...
Paolo will be on vacation on the 8th and the 9th and from the 22nd to the 27th of August.
